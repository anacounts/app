defmodule Anacounts.Accounts.Balance.Means do
  ...
  # - add a value to the database enum (e.g. see migration Anacounts.Repo.Migrations.AddMeansWeightByIncome)
  # - update `params_mismatch/2` in TransferParams
  ...
  defp transfer_balance_params(transfer) do
    if transfer.balance_params do
      ...
      transfer = Anacounts.Repo.preload(transfer, :book)
