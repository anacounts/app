defmodule Anacounts.Accounts.Balance.Means.DivideEquallyTest do
  ...
  alias Anacounts.Accounts.Balance.Means.DivideEqually

  describe "balance_transfer_by_peer" do
    setup :setup_user_fixture
    setup :setup_book_fixture
    setup :setup_book_member_fixture

    test "balances transfer amount among 2 peers", %{book: %{members: [member1]} = book} do
      user2 = user_fixture()
