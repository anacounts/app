defmodule App.BalanceTest do
  ...
  describe "fill_members_balance/1" do
    ...
    test "balances transfers correctly", %{book: book} do
      member1 = book_member_fixture(book, user_fixture())
    ...
    test "weight transfer amount using peers income #1", %{book: book} do
      ...
      member1 = book_member_fixture(book, user1)
  ...
  describe "transactions/1" do
    ...
    test "creates transactions to balance members money #1", %{book: book} do
      member1 = book_member_fixture(book, user_fixture(), balance: Money.new(10, :EUR))
      member2 = book_member_fixture(book, user_fixture(), balance: Money.new(-10, :EUR))
      member3 = book_member_fixture(book, user_fixture(), balance: Money.new(0, :EUR))
    ...
    test "creates transactions to balance members money #2", %{book: book} do
      member1 = book_member_fixture(book, user_fixture(), balance: Money.new(120, :EUR))
      member2 = book_member_fixture(book, user_fixture(), balance: Money.new(33, :EUR))
      member3 = book_member_fixture(book, user_fixture(), balance: Money.new(-12, :EUR))
      member4 = book_member_fixture(book, user_fixture(), balance: Money.new(-121, :EUR))
      member5 = book_member_fixture(book, user_fixture(), balance: Money.new(-20, :EUR))
    ...
    test "returns :error when the balance of a member is corrupted", %{book: book} do
      ...
      member2 =
        book_member_fixture(book, user_fixture(), balance: {:error, "could not compute balance"})
